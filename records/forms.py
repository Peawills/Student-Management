...
class StudentForm(forms.ModelForm):
    ...
    class Meta:
        model = Student
        fields = [
            'surname', 'other_name', 'residential_address', 'permanent_home_address',
            'nationality', 'state_of_origin', 'lga', 'date_of_birth', 'place_of_birth',
            'religion', 'denomination', 'sex', 'admission_no', 'nin_no',
            'class_on_entry', 'date_of_entry', 'class_at_present', 'student_image',
            'father_name', 'father_address', 'father_occupation', 
            'father_educational_level', 'father_mobile',
            'mother_name', 'mother_address', 'mother_occupation',
            'mother_educational_level', 'mother_mobile',
            'guardian_name', 'guardian_address', 'guardian_occupation', 'guardian_mobile',
            'prev_schools', 'visually_impaired', 'deaf', 
            'physically_disabled', 'mentally_impaired', 'others',
        ]
        ...
        widgets = {
            ...
            'permanent_home_address': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 3,
            ...
            'nin_no': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter NIN number'
            }),
            'class_on_entry': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., JSS 1'
            }),
            'date_of_entry': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
            'class_at_present': forms.TextInput(attrs={
                'class': 'form-control',
            ...
            'father_address': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 2
            }),
            ...
            'father_educational_level': forms.TextInput(attrs={
                'class': 'form-control'
            }),
            ...
            'mother_address': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 2
            }),
            ...
            'mother_educational_level': forms.TextInput(attrs={
                'class': 'form-control'
            }),
            'mother_mobile': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., +234...'
            }),
            ...
            'guardian_mobile': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., +234...'
            }),
            'prev_schools': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 3,
                'placeholder': 'List previous schools attended'
            }),
            'visually_impaired': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'deaf': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'physically_disabled': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'mentally_impaired': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
    ...
    def clean_admission_no(self):
        ...
        if qs.exists():
            raise ValidationError("This admission number already exists.")
